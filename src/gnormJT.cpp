...
// [[Rcpp::export]]
double hybridJT(arma::umat Adj, arma::umat EdgeMat, double b, arma::mat D, 
    int iter = 500){
  ...
  for(unsigned int iC=0; iC<nC; iC++){
    if(arma::accu(Adj(Clist[iC]-1, Clist[iC]-1)) == Clist[iC].n_elem*(Clist[iC].n_elem-1)){
      ...
      // Rcpp::Rcout << "computing normalizing constant for sub-graph" << std::endl;
      // lC = lC + gnorm_c(Adj(Clist[iC]-1, Clist[iC]-1), b, D(Clist[iC]-1, Clist[iC]-1), iter);
      lC = lC + approxlogml(Adj(Clist[iC]-1, Clist[iC]-1), b, 
                  D(Clist[iC]-1, Clist[iC]-1), iter);
    }
  }
...
double hybridJT_parallel(arma::umat Adj, arma::umat EdgeMat, double b, arma::mat D, 
  ...
  for(unsigned int iC=0; iC<nC; iC++){
    if(arma::accu(Adj(Clist[iC]-1, Clist[iC]-1)) == Clist[iC].n_elem*(Clist[iC].n_elem-1)){
      ...
      // Rcpp::Rcout << "computing normalizing constant for sub-graph" << std::endl;
      // lC = lC + gnorm_c(Adj(Clist[iC]-1, Clist[iC]-1), b, D(Clist[iC]-1, Clist[iC]-1), iter);
      lC = lC + approxlogml_fast(Adj(Clist[iC]-1, Clist[iC]-1), b, 
                  D(Clist[iC]-1, Clist[iC]-1), iter);
    }
  }
...
// [[Rcpp::export]]
double hybridJT_slow(arma::umat Adj, arma::umat EdgeMat, double b, arma::mat D, 
    int iter = 500){
  ...
  for(unsigned int iC=0; iC<nC; iC++){
    if(arma::accu(Adj(Clist[iC]-1, Clist[iC]-1)) == Clist[iC].n_elem*(Clist[iC].n_elem-1)){
      ...
      // Rcpp::Rcout << "computing normalizing constant for sub-graph" << std::endl;
      // lC = lC + gnorm_c(Adj(Clist[iC]-1, Clist[iC]-1), b, D(Clist[iC]-1, Clist[iC]-1), iter);
      lC = lC + generalApprox(Adj(Clist[iC]-1, Clist[iC]-1), b, 
                  D(Clist[iC]-1, Clist[iC]-1), iter);
    }
  }
